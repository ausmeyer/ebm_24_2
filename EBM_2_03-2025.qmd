...
- **Negative Ultrasound (14% probability):**  
  - Consider further imaging or observation if clinical suspicion remains high.
...
- **Mycoplasma pneumoniae:**  
  ...
  - **Action:** The positive result significantly raises suspicion for Mycoplasma co-infection. Treatment (e.g., macrolides) should be considered.
...
- **Clinical Management:**  
  A negative influenza result nearly rules out the diagnosis. A positive Mycoplasma result, although starting from a low pretest probability, warrants consideration of co-infection treatment.

# Clinical Example 3: Streptococcal Pharyngitis
...
- **Negative RADT (if it occurred):**  
  In high-risk children, a negative RADT does not rule out GAS completely.  
